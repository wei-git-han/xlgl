...
/*
 仅仅只是验证输入的内容是否只是空格，与必填不必填无关
 * */

jQuery.validator.addMethod("trim", function(value, element,a) {
    var bloom = $.trim(value);
    if(bloom==""){
    	bloom = false;
    }else{
    	bloom = true;
    }
    return this.optional(element) || (bloom);
},"请输入正确内容!");
...
jQuery.validator.addMethod("tel", function(value, element,a) {
	if(value == "" || value== null){
		...
		var telnum = /^((\+?86)|(\(\+;86\)))?(13[012356789][0-9]{8}|15[012356789][0-9]{8}|18[02356789][0-9]{8}|19[02356789][0-9]{8}|147[0-9]{8}|1349[0-9]{7})$/;
