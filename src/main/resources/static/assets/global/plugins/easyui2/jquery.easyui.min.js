...
bb.after=$("<span class=\"pagesum\" style=\"padding-right:6px;\"></span>").appendTo(tr).wrap("<td></td>");
}else{
if(_b2=="refresh"){
...
_72b.pagination("refresh",{pageNumber:opts.pageNumber||_72c.pageNumber,total:data.total});
