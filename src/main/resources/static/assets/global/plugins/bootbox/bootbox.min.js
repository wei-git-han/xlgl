...
! function(a, b) {
	...
	var n = {
			...
			closeButton: "<div  class='newclose' data-dismiss='modal' aria-hidden='true'><i class='fa fa-times'></i></div>",
	...
	p.alert = function() {
		...
		if (g(j, function(a, b) {
			...
			a.title ? d.find(".modal-header").prepend(m) : m.css("margin-top", "0px").prependTo(i)
		}
	...
	return p.addLocale = function(a, c) {
		return b.each(["确定", "CANCEL", "CONFIRM"], function(a, b) {
