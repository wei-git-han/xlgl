...
public class XlglWarCommonWarbasisController {
	...
	@ResponseBody
	@RequestMapping("/save")
	public void save(XlglWarCommonWarbasis xlglWarCommonWarbasis, String coverFile, String videoFile,
	...
	public void update(XlglWarCommonWarbasis xlglWarCommonWarbasis) {
		...
		if (StringUtils.isNotBlank(xlglWarCommonWarbasis.getAccessoryFile())) {
			if (xlglWarCommonWarbasis.getAccessoryFile().contains(",")) {
				...
				xlglPictureService.savePicture(xlglWarCommonWarbasis.getId(), xlglWarCommonWarbasis.getAccessoryFile(),
						"3");
			}
		}
		Response.ok();
